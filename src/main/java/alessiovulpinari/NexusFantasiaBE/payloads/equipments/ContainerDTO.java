...
public record ContainerDTO(@NotEmpty(message = "Il nome dell'oggetto non può essere vuoto!") String name,
                           ...
                           @NotEmpty(message = "La capacità dell'oggetto non può essere vuota!") String capacity) {
}
